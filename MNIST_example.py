...
x.add_layer(PoolLayer("Pool4", (2, 2)))
x.add_layer(FlattenLayer("Flat2"))
x.add_layer(PoolLayer("Sub2", (2, 2)), source="Sub1")
x.add_layer(ConvLayer("Conv5", 10, (2, 2), r))
x.add_layer(ConvLayer("Conv6", 10, (2, 2), r))
x.add_layer(FlattenLayer("Flat3"))
x.add_layer(JoinLayer("Join1", axis=1), source=("Flat1", "Flat2", "Flat3"))
