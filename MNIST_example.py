...
x = Model((1, 28, 28))
n_iters = 13
x.add_layer(ConvLayer("Conv1", 10, (3, 3), r, activation="leaky_relu", init_method="glorot"))
x.add_layer(PoolLayer("Pool1", (2, 2), mode="max"))
x.add_layer(ConvLayer("Conv2", 5, (3, 3), r, activation="leaky_relu", init_method="glorot"))
x.add_layer(PoolLayer("Pool2", (2, 2)))
x.add_layer(PoolLayer("Sub1", (2, 2), mode="avg"), source="inputs")
x.add_layer(ConvLayer("Conv3", 10, (3, 3), r, activation="leaky_relu", init_method="glorot"))
x.add_layer(PoolLayer("Pool3", (2, 2)))
x.add_layer(ConvLayer("Conv4", 5, (2, 2), r, activation="leaky_relu", init_method="glorot"))
x.add_layer(PoolLayer("Sub2", (2, 2)), source="Sub1")
x.add_layer(ConvLayer("Conv5", 10, (2, 2), r, activation="leaky_relu"))
x.add_layer(ConvLayer("Conv6", 10, (2, 2), r, activation="leaky_relu"))
x.add_layer(JoinLayer("Join1", axis=1), source=("Pool2", "Conv4", "Conv6"))
x.add_layer(ConvLayer("Conv7", 10, (2, 2), r, activation="leaky_relu"))
x.add_layer(FlattenLayer("Flat1"))
x.add_layer(BNLayer("BN1"))
x.add_layer(FCLayer("FC1", 400, r, "elu"))
